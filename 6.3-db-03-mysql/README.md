...
### Ответ
```
1. Найдите команду для выдачи статуса БД и **приведите в ответе** из ее вывода версию сервера БД.
\s
Server version:		8.0.29 MySQL Community Server - GPL

2. **Приведите в ответе** количество записей с `price` > 300.
...
### Ответ
```
baloo@pc:~/devops/6.3-db-03-mysql/mysql$ sudo docker exec -it mysql bash
root@332cf17e9185:/# cat /etc/mysql/my.cnf 
